    ...
    if (inAutoScrollBeginArea) {
      ...
      this._startAutoScroll({
        ...
        shouldScroll: () => {
          ...
          if (horizontal) {
            return (
              this._contentOffset.x < contentWidth - this.containerLayout.width
            );
          } else {
            return (
              this._contentOffset.y <
              contentHeight + footerLayout.height - this.containerLayout.height
            );
          }
        },
        getScrollStep: stepIndex => {
